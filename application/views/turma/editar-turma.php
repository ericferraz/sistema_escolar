...
<div class="page-content">
            ...
            <div class="col-xs-12">
                <form id="formulario" name="form1" method="post">
                        ...
                        <div class="col-xs-5">
                            <div>
                                <select name="id_curso_turma">
                                    ...
                                    <?php } else {
                                      foreach ($cursos as $c):
                                          $selected = $c->id_curso == $turmas->id_curso_turma ? "selected" : "" ;
                                        ?>
                                        <option value="<?php echo $c->id_curso; ?>" <?php echo $selected; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="text" name="nome_turma" value="<?php echo set_value('nome_turma') ? set_value('nome_turma') : $turmas->nome_turma; ?>" class="full-width">
                        </div>
                        <div class="col-xs-1">
    ...
    <?php }?>
     <div class="col-xs-12">
          <a href='<?php echo base_url().'turma/listar' ?>'><button class="btn btn-success">Voltar</button></a>
      </div> 
        </div><!-- /.col -->
