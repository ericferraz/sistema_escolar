...
<div class="page-content">
    ...
    <?php if(!isset($paises) || empty($paises)){ ?>
        <div class="alert alert-danger">País não encontrado</div>   
    <?php } else{?>
            ...
            <div class="col-xs-12">
                <form id="formulario" name="form1" method="post" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="text"  name="nome_pais" value="<?php echo set_value('nome_pais') ? set_value('nome_pais'):$paises->nome_pais ; ?>" class="full-width">
                        </div>
                        <div class="col-xs-1">
    ...
    <?php }?>
             <div class="col-xs-12">
                <a href='<?php echo base_url().'pais/listar' ?>'><button class="btn btn-success">Voltar</button></a>
         </div> 
        </div><!-- /.col -->
