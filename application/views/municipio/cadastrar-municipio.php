...
<div class="page-content">
    ...
    <div class="row">
     ...
     <?php endif; ?>   
            ...
            <div class="col-xs-12">
                <form id="formulario" name="form1" method="post" action="<?php echo base_url() ?>municipio/cadastrar">
                    <br>
                    <!-- SELECT -->
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="text"  name="nome_municipio" value="<?php echo set_value('nome_municipio'); ?>" class="full-width">
                        </div>
                        <div class="col-xs-1">
