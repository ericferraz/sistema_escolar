...
<div class="page-content">
    ...
    <div class="row">
     ...
     <?php endif; ?>   
            ...
            <div class="col-xs-12">
                <form id="formulario" name="form1" method="post" action="<?php echo base_url() ?>matricula/matricular" >
                    <br>
                      <!-- TEXTFIELD -->
                    <div class="row">
                                ...
                                <select name="id_aluno_matricula">
                                    ...
                                    <?php } else {
                                      foreach ($alunos as $a):
                                        ...
                                        <option value="<?php echo $a->id_aluno; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="date" name="data_matricula" value="<?php echo set_value('data_matricula'); ?>" class="full-width">
                        </div>
                        <div class="col-xs-1">
