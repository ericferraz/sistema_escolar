...
<div class="page-content">
    ...
    <div class="row">
     ...
     <?php endif; ?>   
            ...
            <div class="col-xs-12">
                <form id="formulario" name="form1" method="post" action="<?php echo base_url() ?>curso/cadastrar" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="text"  name="nome_curso" value="<?php echo set_value('nome_curso'); ?>" class="full-width">
                        </div>
                        <div class="col-xs-1">
